...
<?php if (is_admin()): ?>
    <p><a class="btn accent" href="index.php?page=order_edit">Добавить заказ</a></p>
<?php endif; ?>
...
<table>
    ...
    <?php foreach ($orders as $o): ?>
        <tr class="<?= is_admin() ? 'clickable' : '' ?>"
            <?php if (is_admin()): ?>
            onclick="if(!event.target.closest('a,button'))location.href='index.php?page=order_edit&id=<?= (int)$o['id'] ?>'"
            <?php endif; ?>>
            <td><?= (int)$o['id'] ?></td>
